...
The parameter `saveas` is not required, but is is useful to know that you can save dashboards anywhere you want to. You can download `survey.pdf` here. 
