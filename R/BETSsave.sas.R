...
#'  BETSsave.sas(data = us.brl.seasonally_adjusted,file.name="us.brl.seasonally_adjusted")
#'  # Or
#'  BETSsave.sas(code=3691,file.name="us.brl")
#' @import foreign
#' @export 


BETSsave.sas=function(code, data = NULL, file.name="series"){
