...
#'  
#' @description 
#' Pior perda esperada para certo volume investido, sob condicoes normais
#' de mercado e dentro de pequeno e determinado nível de confianca.
#' 
#' 
#'  
#' @usage BETSparamVaR(x , volume, conf.level )
#'  
#'  
#'  
...
#' 
#' BETSparamVaR(garch.fit,volume = 30000,conf.level=0.90)
#' BETSparamVaR(garch.fit,volume = 30000,conf.level=0.95)
#' BETSparamVaR(garch.fit,volume = 30000,conf.level=0.99)
#'  
...
BETSparamVaR = function(x, volume, conf.level){
