...
#' 
#' @return A \code{list} whose elements are:
#' 
#' \itemize{
...
#' \item{\code{net}: A \code{list} object returned by the \link[grnn]{grnn} function. Represents a trained net. }
