...
#' @examples
#' sidra=get.series.sidra(x = c(1612), from = 1990, to = 2015, territory = "brazil")
...
#' # sections = "all", cl = 544)
#' # sidra=get.series.sidra(x = c(1618), from = c("201703"), to = c("201703"), 
#' # territory = "brazil",
...
#' # sidra = get.series.sidra(x = 1620, from = 199001, to = 201701,  
#' # territory = "brazil",
#' # sections=list(c(90687)), cl =c(11255), variable = 583)
