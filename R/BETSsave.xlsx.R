...
#'  BETSsave.xlsx(data = us.brl.seasonally_adjusted,file.name="us.brl.seasonally_adjusted")
#'  # Or
#'  BETSsave.xlsx(code=3691,file.name="us.brl")
#' @import  xlsx
#' @export 


BETSsave.xlsx=function(code, data = NULL, file.name="series"){
