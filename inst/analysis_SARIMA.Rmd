...
>> FAZER COMENTARIO SOBRE O ARCH TEST

```{r}
arch.test <- BETS.arch_test(resid(model))

### COLOCAR PARAMETRO NIVEL DE SIGNIFICANCIA PARA O USUARIO
if(arch.test$p.value >= 0.05){
    htk = TRUE
} else { htk = FALSE }
```

>> VAMOS TER QUE PASSAR O LOG E REFAZER TUDO
